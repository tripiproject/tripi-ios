...
@implementation TRIPIHTMLTagItem
...
- (BOOL)isEqualToTagItem:(TRIPIHTMLTagItem *) aTagItem {
...
- (BOOL)isEqual:(id) anObject {
	...
	if (![anObject isKindOfClass:[TRIPIHTMLTagItem class]]) {
		return NO;
	}

	return [self isEqualToTagItem:(TRIPIHTMLTagItem *)anObject];
}
