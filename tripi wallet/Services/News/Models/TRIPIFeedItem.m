...
- (BOOL)isEqualToFeedItem:(TRIPIFeedItem *) aFeedItem {
...
- (BOOL)isEqual:(id) anObject {
	...
	if (![anObject isKindOfClass:[TRIPIFeedItem class]]) {
		return NO;
	}

	return [self isEqualToFeedItem:(TRIPIFeedItem *)anObject];
}
