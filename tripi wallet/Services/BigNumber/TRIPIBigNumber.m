...
+ (instancetype)decimalWithString:(NSString *) string {
	...
	TRIPIBigNumber *decimal = [[TRIPIBigNumber alloc] initWithString:string];
	return decimal;
}
...
+ (instancetype)decimalWithInteger:(NSInteger) integer {
    ...
    NSString *intString = [NSString stringWithFormat:@"%li", (long)integer];
	TRIPIBigNumber *decimal = [[TRIPIBigNumber alloc] initWithString:intString];
	return decimal;
}
...
- (instancetype)add:(TRIPIBigNumber *) bigDecimal {
	...
	TRIPIBigNumber *res = [TRIPIBigNumber decimalWithString:resDecimal.stringValue];
	return res;
}
...
- (BTCAmount)satoshiAmountValue {
	...
	TRIPIBigNumber *amountMultiplyNumber = [[TRIPIBigNumber alloc] initWithInteger:BTCCoin];
...
@implementation TRIPIBigNumber (Comparison)
...
- (TRIPIBigNumber* )roundedNumberWithScale:(NSInteger) scale {
	...
	return [TRIPIBigNumber decimalWithString:number.stringValue];
}

@end

@implementation TRIPIBigNumber (Format)
...
- (TRIPIBigNumber *)numberWithPowerOfMinus10:(TRIPIBigNumber *) power {
	...
	return [TRIPIBigNumber decimalWithString:bigDecimal.stringValue];
}
...
- (TRIPIBigNumber *)tenInPower:(TRIPIBigNumber *) power {
...
+ (TRIPIBigNumber*)maxBigNumberWithPowerOfTwo:(NSInteger) power isUnsigned:(BOOL) isUnsigned {
    ...
    return [TRIPIBigNumber decimalWithString:value];
}
