...
+ (PopUpContent *)contentForPhotoLibrary {
	PopUpContent *content = [[PopUpContent alloc] initWithTitle:NSLocalizedString(@"TRIPI App would like to access your photos", nil) message:nil okTitle:NSLocalizedString(@"OK", nil) cancelTitle:NSLocalizedString(@"TRY AGAIN", nil)];
	return content;
}
