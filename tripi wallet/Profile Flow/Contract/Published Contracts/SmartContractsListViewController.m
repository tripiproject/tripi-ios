...
@interface SmartContractsListViewController () <UITableViewDelegate, UITableViewDataSource, TRIPISwipableCellWithButtonsDelegate, UIGestureRecognizerDelegate, RemoveContractTrainigViewDelegate, SmartContractListItemCellDelegate>
...
#pragma mark - TRIPISwipableCellWithButtonsDelegate
...
- (void)cellDidOpen:(UITableViewCell *) cell {
	...
	for (TRIPISwipableCellWithButtons *openedCell in self.cellsCurrentlyEditing) {
...
- (void)cellDidStartMoving:(UITableViewCell *) cell {
	...
	if (self.movingCell) {
		[(TRIPISwipableCellWithButtons *)self.movingCell closeCell];
	}
...
- (void)cellEndMoving:(UITableViewCell *) cell {
	...
	if (![cell isEqual:self.movingCell]) {
		[(TRIPISwipableCellWithButtons *)cell closeCell];
	} else {
		self.movingCell = nil;
