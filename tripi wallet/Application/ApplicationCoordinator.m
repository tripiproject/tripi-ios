...
- (void)startMainFlow {
    ...
    [controller setControllerForSend:send forWallet:wallet forProfile:profile];
	...
	if (self.adress) {
		SendInfoItem *item = [[SendInfoItem alloc] initWithTripiAddress:self.adress tokenAddress:nil amountString:self.amount];
