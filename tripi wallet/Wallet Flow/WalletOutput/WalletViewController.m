...
- (void)reloadHeader:(id <Spendable>) wallet {
    ...
    dispatch_async (dispatch_get_main_queue (), ^{
        ...
        weakSelf.uncorfirmedLabel.text = [NSString stringWithFormat:@"%@ %@", [SLocator.walletBalanceFacadeService.lastUnconfirmedBalance roundedNumberWithScale:blanceRoundingCount], NSLocalizedString(@"TRIPI", nil)];
        weakSelf.availabelLabel.text = [NSString stringWithFormat:@"%@ %@", [SLocator.walletBalanceFacadeService.lastBalance roundedNumberWithScale:blanceRoundingCount], NSLocalizedString(@"TRIPI", nil)];
