...
@property (weak, nonatomic) IBOutlet UILabel *animatedTRIPILabel;
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *animatedTRIPILabelHeightConstraint;
...
- (void)viewDidAppear:(BOOL) animated {
	...
	dispatch_after (dispatch_time (DISPATCH_TIME_NOW, (int64_t)(tripiLabelCoeff * duration * NSEC_PER_SEC)), dispatch_get_main_queue (), ^{

		weakSelf.animatedTRIPILabelHeightConstraint.constant = 0;
